...
# =========================================================================
class Indexer:
    def __init__(self, input_dictionary, output_file_dictionary, output_file_postings, previous_dictionary):
        ...
        self.whichFile = 1
        self.mainDict = previous_dictionary
    ...
    def indexDictionary(self, numberOfFilesToProcess = 0): 
        ...
        dictionary = self.processFiles(numberOfFilesToProcess, self.input_dictionary, self.mainDict)
        print("Pickle")
        exportDSJSON(dictionary, self.dictionaryFile)
...
#           output: None
# =========================================================================   
    def processFiles(self, numberOfFilesToProcess, input_dictionary, previous_dictionary):
        Main_Dictionary = previous_dictionary
        ...
        for caseID in input_dictionary:
            ...
            contentDict = makeTriGrams(input_dictionary[caseID]["content"])
            dictToProcess = dict(title = dict(), content = contentDict, date_posted = dict(), court = dict())
...
#input_dictionary = importDSJSON(input_dictionary)
previous_dictionary = importDSJSON(output_file_dictionary)
print("import done")
indexer = Indexer(dummyDocs, output_file_dictionary, output_file_postings, previous_dictionary)
indexer.indexDictionary(0)
# python indexfrompre_HW4.py -i Predictionary.txt -d splitdictionary.txt -p splitpostings.txt